...
@section('tip')
    ...
    @else
        <div class=" pb-md-4 mx-auto text-center" style="padding-top:30px; padding-bottom:30px; ">
            <h1 class="display-4 fw-normal">加入永久會員</h1>

        </div>
        <div>
            <p class="fs-5 ">「永久會員」細則</p>
            <p class="fs-5 pb-5">填寫左方表格，遞交後經執委會審定符合兩年或以上的資深會員資格，通過後並繳付$900永久會費，便獲電郵通知成為永久會員
                <br>除可參與本會活動，享有會員福利及購物優惠外，在周年大會享有投票權及參選權。
