      ...
      @else
          ...
          <div>
              ...
              <p class="fs-5 pb-5">填寫申請表，遞交後獲電郵電子會員證，無須繳付會費。
                  <br>普通會員可參與本會舉辦的活動，享有會員福利及購物優惠，在本會周年大會中沒有投票權及參選權。
              </p>
          </div>
      @endif
...
{{--            <button type="button" class="btn-close"   aria-label="Close"></button>--}}
    ...
    <form action="" id="_form">
        ...
        <div class="form-group pb-3">
            ...
            <input type="tel" required class="form-control" value="{{ $member->phone }}" name="mobile" id="typePhone"  placeholder="手提電話">
        </div>

        <div class="form-group pb-3">
            <label for="exampleInputEmail1">個人電郵</label>
            <input type="email" required class="form-control" value="{{ $member->email }}" name="email" id="email" aria-describedby="emailHelp" placeholder="個人電郵">
        </div>
        ...
        <div id="work-info">
            ...
            <div class="form-check">
                <input class="form-check-input"
                       @if($member->job_type == 2)
                           checked
                       @endif
                       type="radio" id="exampleRadios2" name="workerinfo"   value="2">
        ...
        <div id="school-wraper">
            <div class="form-group pb-3">
                ...
                <input type="text"  class="form-control" value="{{ $member->company }}" name="teach-school" placeholder="任教學校">
            </div>

            <div class="form-group pb-3">
                <label for="school">就讀院校</label>
                <input type="text" class="form-control" value="{{ $member->company }}" name="study-school" placeholder="就讀院校">
            </div>

            <div class="form-group pb-3">
                <label for="school">工作機構</label>
                <input type="text" class="form-control" value="{{ $member->company }}" name="work-school" placeholder="工作機構">
            </div>

            <div class="form-group pb-3">
                <label for="school">前任教學校</label>
                <input type="text" class="form-control" value="{{ $member->company }}" name="pre-school" placeholder="前任教學校">
            </div>
        </div>
        ...
        <div class="form-group pb-5">
            ...
            <input type="text" name="job_name" required class="form-control" value="{{ $member->job_name }}" id="post" placeholder="職位">
        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="row mb-3">
                            <label for="staticEmail" class="col-sm-3 col-form-label" id="woker_info_label">任教學校:</label>
                            <div class="col-sm-9">
                                <div class="form-control-plaintext">
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-12">本人謹此證明以上資料均屬真實無誤。</div>
                        </div>
